...
const nmaeData: DataPoint[] = [
  { model: "ARIMA", nmae: 5.20, color: "#8b5cf6" },
  { model: "ETS", nmae: 1.10, color: "#8b5cf6" },
  { model: "Llama 3B", nmae: 26.65, color: "#e09f3e" },
  { model: "Mistral 8x7B", nmae: 0.846, color: "#e09f3e" },
  { model: "GPT-4o mini", nmae: 1.165, color: "#e09f3e" },
]

const winRateData: DataPoint[] = [
  { model: "ARIMA", rate: 31.7, color: "#8b5cf6" },
  { model: "ETS", rate: 10.0, color: "#8b5cf6" },
  { model: "Llama 3B", rate: 0.0, color: "#e09f3e" },
  { model: "Mistral 8x7B", rate: 25.0, color: "#e09f3e" },
  { model: "GPT-4o mini", rate: 19.2, color: "#e09f3e" },
]
const tooltipStyle = {
    ...
    <div className="flex flex-col gap-6">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4">
        <p className="text-xs text-slate-500 font-mono leading-relaxed">
          ...
          a difference that is <span className="text-violet-400 font-semibold">not statistically significant (p = 0.957)</span>.
